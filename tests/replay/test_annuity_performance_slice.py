...
def test_annuity_performance_slice_replay_uses_failed_checkpoint_payloads(tmp_path) -> None:
    """Test: when a intermediate checkpoint fails, the compatibility case truthfully
    ...
    outcome_pass = run_annuity_performance_slice(
        workbook=workbook_path,
        period="2026-03",
        replay_root=replay_root,
    )
    ...
    outcome_fp = run_annuity_performance_slice(
        workbook=workbook_path,
        period="2026-03",
        replay_root=replay_root,
    )
    ...
    outcome_ir = run_annuity_performance_slice(
        workbook=workbook_path,
        period="2026-03",
        replay_root=replay_root,
    )
    ...
    outcome_cs = run_annuity_performance_slice(
        workbook=workbook_path,
        period="2026-03",
        replay_root=replay_root,
    )
