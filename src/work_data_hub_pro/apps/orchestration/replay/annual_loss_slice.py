...
def run_annual_loss_slice(
    *,
    ...
    intake = AnnualLossIntakeService()
    ...
    processor = AnnualLossProcessor(cleansing_manifest)
    ...
    validate_publication_plan(publication_plan_loss)
    ...
    publication_plan_loss_signal = build_publication_plan(
        policy=publication_policy,
    ...
    validate_publication_plan(publication_plan_loss_signal)
    publication_results = publication.execute(
        [
            PublicationBundle(
                plan=publication_plan_loss,
                rows=[
            ...
            PublicationBundle(
                plan=publication_plan_loss_signal,
                rows=[
                    candidate.candidate_payload
                    for candidate in derivation_candidates
